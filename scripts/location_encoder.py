...
def _resolve_posenc_compute_dtype(dtype, posenc_compute_dtype):
...
class StableAnalyticSphericalHarmonics(nn.Module):
    def __init__(self, legendre_polys, compute_dtype=torch.float64, output_dtype=None):
        super().__init__()
    ...
    def _init_constants(self):
        ...
        self.register_buffer("flat_degree", torch.tensor(flat_degree, dtype=torch.int64), persistent=False)
